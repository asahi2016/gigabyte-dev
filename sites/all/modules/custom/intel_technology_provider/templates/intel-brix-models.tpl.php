                                ...
                                <div style="display: none;" id="term-<?php print $term->tid;?>">
                                    <div id="<?php print $term->name;?>" style="height:400px;">
                                        ...
                                        <table class="pop">
                                            <tbody>
                                            <tr>
                                                <?php foreach ($term->subterm as $skey => $subterm){ ?>
                                                    <td><a href="<?php print $subterm->term->field_brix_link['und'][0]['url']; ?>" target="_blank"><?php print $subterm->term->field_brix_link['und'][0]['title']; ?></a></td>
                                                <?php } ?>
                                            </tr>
                                            </tbody>
                                        </table>
